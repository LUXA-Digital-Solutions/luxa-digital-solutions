      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 sm:mb-20 lg:mb-24 animate-slide-up">
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-muted-foreground max-w-4xl mx-auto leading-relaxed px-4 sm:px-6">
            Discover how we've helped businesses achieve remarkable digital transformation through innovative technology solutions.
          </p>
        </div>
        ...
        <div className="space-y-16 sm:space-y-20 lg:space-y-24 mb-16 sm:mb-20 lg:mb-24">
          {featuredProjects.map((project, index) => (
            <Card 
              key={project.id}
              className="group bg-card/30 border-border/30 hover:border-primary/40 backdrop-blur-sm transition-all-spring hover-lift relative overflow-hidden"
                ...
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-0 ${
                  ...
                  <div className={`relative overflow-hidden ${
                    ...
                    <div className="aspect-[16/10] relative group-hover:scale-105 transition-transform duration-700 ease-out">
                      ...
                      <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-all-spring transform translate-y-2 group-hover:translate-y-0">
                        <div className="flex gap-2">
                          <Button 
                            ...
                            className="bg-primary/90 hover:bg-primary text-black font-semibold w-10 h-10 p-0 rounded-full hover:scale-110 transition-all-spring shadow-lg"
                          >
                      ...
                      <div className="absolute top-4 left-4">
                        <Badge variant="secondary" className="bg-primary/90 text-black border-0 font-semibold px-3 py-1 text-xs">
                          {project.category}
                        </Badge>
                      </div>
                    </div>
                  ...
                  <div className={`p-8 sm:p-10 lg:p-12 flex flex-col justify-center ${
                    ...
                    <div className="space-y-6 sm:space-y-8">
                      ...
                      <div>
                        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 group-hover:text-primary transition-colors duration-300 leading-tight">
                          {project.title}
                        </h3>
                      ...
                      <div className="grid grid-cols-2 gap-4 sm:gap-6">
                        <div className="flex items-center space-x-3 group/stat">
                          <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center group-hover/stat:scale-110 transition-transform duration-300">
                            <Users className="w-4 h-4 text-primary" />
                          </div>
                          <div>
                            <div className="text-sm text-muted-foreground">Team Size</div>
                            <div className="font-semibold text-foreground group-hover/stat:text-primary transition-colors duration-300">
                        ...
                        <div className="flex items-center space-x-3 group/stat">
                          ...
                          <div>
                            ...
                            <div className="font-semibold text-foreground group-hover/stat:text-primary transition-colors duration-300 text-sm">
                              {project.client}
                            </div>
                          </div>
                        </div>
        ...
        <div className="text-center animate-slide-up">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-8 sm:mb-10 leading-relaxed px-4 sm:px-6">
              Let's discuss how we can create similar transformative results for your business.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
              <Button 
                size="lg" 
                onClick={() => navigate('/get-quote')}
                className="bg-gradient-primary hover:shadow-cyan transition-all-spring hover-lift px-10 sm:px-12 lg:px-16 py-5 sm:py-6 lg:py-7 text-xl sm:text-2xl lg:text-3xl font-semibold group relative overflow-hidden w-full sm:w-auto"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              ...
              <Button 
                ...
                className="border-primary/40 text-foreground hover:bg-primary/10 hover:border-primary/60 transition-all-spring hover-lift px-10 sm:px-12 lg:px-16 py-5 sm:py-6 lg:py-7 text-xl sm:text-2xl lg:text-3xl font-semibold w-full sm:w-auto"
              >
                View All Projects
              </Button>
            </div>
