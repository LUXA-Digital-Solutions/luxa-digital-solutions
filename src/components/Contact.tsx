      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-16 sm:mb-20 lg:mb-24">
          ...
          <div className="animate-slide-up">
            <Card className="p-6 sm:p-8 lg:p-10 bg-card/30 border-border/30 backdrop-blur-sm relative overflow-hidden group hover:border-primary/40 transition-all-spring">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-primary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              
              <div className="relative z-10">
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 sm:mb-8 group-hover:text-primary transition-colors duration-300">
                  Send us a Message
                </h3>
                ...
                <form className="space-y-6 sm:space-y-8">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div className="space-y-2">
                      ...
                      <Input 
                        id="firstName" 
                        placeholder="John" 
                        className="h-12 sm:h-14 border-border/50 hover:border-primary/40 focus:border-primary transition-all-spring bg-background/50 backdrop-blur-sm"
                      />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="lastName" className="text-sm sm:text-base font-medium text-foreground">
                        Last Name
                      </Label>
                      <Input 
                        id="lastName" 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="company" className="text-sm sm:text-base font-medium text-foreground">
                      Company
                    </Label>
                    <Input 
                      id="company" 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="service" className="text-sm sm:text-base font-medium text-foreground">
                      Service Interest
                    </Label>
                    <Select>
                      <SelectTrigger className="h-12 sm:h-14 border-border/50 hover:border-primary/40 focus:border-primary transition-all-spring bg-background/50 backdrop-blur-sm">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      rows={4}
                      className="border-border/50 hover:border-primary/40 focus:border-primary transition-all-spring bg-background/50 backdrop-blur-sm resize-none"
                    />
                  </div>

                  <Button 
                    type="submit" 
                    className="w-full bg-gradient-primary hover:shadow-cyan transition-all-spring hover-lift py-4 sm:py-5 lg:py-6 text-lg sm:text-xl lg:text-2xl font-semibold group relative overflow-hidden"
                  >
          ...
          <div className="animate-slide-up-delayed">
            <div className="space-y-6 sm:space-y-8">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-xl bg-gradient-accent flex items-center justify-center mb-3 sm:mb-4 group-hover:animate-glow transition-all-spring group-hover:scale-110">
                        <method.icon className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-primary" />
                      </div>
                      
                      <h4 className="font-semibold mb-2 text-sm sm:text-base lg:text-lg group-hover:text-primary transition-colors duration-300">
                        {method.title}
                      </h4>
              ...
              <Card className="p-6 sm:p-8 bg-gradient-accent border-primary/20 backdrop-blur-sm relative overflow-hidden group hover:border-primary/40 transition-all-spring">
                ...
                <div className="relative z-10 text-center">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-2xl bg-primary/20 flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:animate-glow transition-all-spring group-hover:scale-110">
                    <MessageSquare className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-primary" />
                  </div>
                  
                  <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-3 sm:mb-4 group-hover:text-primary transition-colors duration-300">
                    Free Consultation
                  </h3>
        ...
        <div className="text-center animate-slide-up">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-8 sm:mb-10 leading-relaxed px-4 sm:px-6">
              Ready to transform your business? Our team is here to help you achieve your digital goals.
            </p>
