      ...
      (item: LogoItem, key: React.Key) => {
        ...
        const content = isNodeItem ? (
          <span
            ...
            aria-hidden={
              !!(item as { node: React.ReactNode; href?: string }).href &&
              !(item as { node: React.ReactNode; ariaLabel?: string }).ariaLabel
            }
          >
        ...
        const itemAriaLabel = isNodeItem
          ? (item as { ariaLabel?: string; title?: string }).ariaLabel ??
            (item as { title?: string }).title
          : (item as { alt?: string; title?: string }).alt ??
            (item as { title?: string }).title;
