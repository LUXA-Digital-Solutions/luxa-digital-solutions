...
const ProjectDetail = () => {
  ...
  const getTechnologyIcon = (tech: string) => {
    ...
    if (techLower.includes('design') || techLower.includes('figma')) return Palette;
    if (techLower.includes('mobile') || techLower.includes('ios') || techLower.includes('android')) return Smartphone;
    ...
    if (techLower.includes('security') || techLower.includes('ssl')) return Lock;
    if (techLower.includes('analytics') || techLower.includes('chart')) return BarChart3;
    return Globe;
  };
      ...
      <main className="pt-20">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-dark">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-20 right-20 w-32 h-32 bg-primary/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="animate-slide-up-delayed space-y-8">
                  {/* Project Badge */}
                  <Badge variant="secondary" className="bg-primary/10 text-primary border-primary/20 px-4 py-2 text-sm font-semibold">
                    {project.category}
                  </Badge>
                  ...
                  {/* Enhanced Tech Stack */}
                  <div>
                    <h3 className="text-lg font-semibold text-muted-foreground mb-4 uppercase tracking-wider">Technologies Used</h3>
                    ...
                    <div className="aspect-[4/3] relative group-hover:scale-105 transition-transform duration-700 ease-out">
                      ...
                      <div className="absolute bottom-6 left-6 right-6 opacity-0 group-hover:opacity-100 transition-all-spring transform translate-y-4 group-hover:translate-y-0">
                        <div className="bg-black/60 backdrop-blur-sm rounded-xl p-4 border border-primary/30">
                          <p className="text-white font-medium text-center">Click to view full project</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      {project.features.map((feature, index) => (
                        <div key={index} className="flex items-start group/feature">
                          ...
                          <span className="text-muted-foreground group-hover/feature:text-foreground transition-colors duration-300 leading-relaxed text-lg">{feature}</span>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <Card className="max-w-6xl mx-auto p-20 bg-card/30 border-primary/20 backdrop-blur-sm text-center relative overflow-hidden group hover:border-primary/40 transition-all-spring">
                ...
                <div className="relative z-10">
                  <div className="flex justify-center mb-10">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-10 h-10 text-primary fill-current mx-2 group-hover:scale-110 transition-transform duration-300" />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    <div className="text-left">
                      <div className="font-semibold text-2xl group-hover:text-primary transition-colors duration-300">{project.testimonial.author}</div>
